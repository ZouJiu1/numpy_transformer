...
def getdata():
    ...
    id2char_char2id = os.path.join(abspath, 'dataset', r"gptpoetry6000.json")
    # inpath = os.path.join(abspath, 'dataset', r"train_10000.txt")
    
    inpath = r'C:\Users\10696\Desktop\access\numpy_transformer\dataset\train_6000.txt'
...
def transformer_image_train():
    ...
    logfile = os.path.join(logdir, 'log_gpt_poetry6000.txt')
    ...
    while alliter < all_steps:
        ...
        while True:
            ...
            if (alliter + 1) % 100==0:
                ...
                name = f"gpt_poetry6000_iters{alliter}_"+str(i)+"_loss_"+str(round(meanloss, 6))+".pkl"
...
if __name__ =="__main__":
    savepath = abspath
    pretrained_model = r'C:\Users\10696\Desktop\access\numpy_transformer\gpt\model\gpt_poetry6000_iters2999_0_loss_7667.469238.pkl'
