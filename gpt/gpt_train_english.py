...
def getdata():
    ...
    id2char_char2id = os.path.join(abspath, 'dataset', r"crsto10.json")
    inpath = os.path.join(abspath, 'dataset', "gutenberg", r"crsto10.txt")
...
if __name__ =="__main__":
    single_word = False
    savename = f"gpt_english_last1.pkl"
