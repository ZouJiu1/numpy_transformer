...
def transformer_image_train(num_classes):
    ...
    cll = gpt_linear_layer(embed_dim, vocab_size)
    layers += [norm, cll]
    ...
    for i in range(epoch):
        ...
        while True:
            ...
            input_mask = np.array([[1,1,0], [1,0,0]])
        ...
        name = "gpt_epoch_"+str(i)+"_loss_"+str(round(meanloss, 6))+".pkl"
