...
class attdecoderblock_layer():
    def __init__(self, embed_dim, num_h, adam=False, float32 = False, float16 = False, return_attention = False):
        self.embed_dim = embed_dim
        self.num_h = num_h
        self.len_single =  embed_dim // num_h

        self.norm = layer_norm(self.embed_dim, adam=adam, float32=float32, float16=float16)
        self.norm1 = layer_norm(self.embed_dim, adam=adam, float32=float32, float16=float16)
        self.qkvfc = fclayer(self.embed_dim, self.len_single * num_h * 3, True, adam=adam, float32=float32, float16=float16)
        
        self.fc0 = fclayer(self.embed_dim, self.embed_dim * (2*2), True, adam=adam, float32=float32, float16=float16)
        self.fc1 = fclayer(self.embed_dim * (2*2), self.embed_dim, True, adam=adam, float32=float32, float16=float16)
        self.fc_out = fclayer(self.embed_dim, self.embed_dim, True, adam=adam, float32=float32, float16=float16)
