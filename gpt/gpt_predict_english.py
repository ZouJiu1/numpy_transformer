...
from gpt.gpt_train_english import getdata, create_masks_future
from net.layernorm import layer_norm
...
def predict():
    ...
    embed_dim = vocab_size//3  # vocab_size if vocab_size%3==0 else (vocab_size//3) * 3 + 3 # 192
    num_layer = 10 + 1 + 1
    num_h = [3] * num_layer
    ...
    inputs = r'and insurance companies It’s all temples and olive trees, and peacocks and elephants,'
